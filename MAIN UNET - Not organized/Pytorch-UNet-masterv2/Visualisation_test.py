...
# A COPY MODIFIED TO JUST CREATE PLOTS TO VISUALIZE SAMPLES
...
def test_model(model, device, folder, batch_size: int = 3,amp: bool = False, TempDim: bool = False, BGS_input: bool = False, dataset_size=[350,350], ModLoss = False):
    ...
    Visualize_Preds(net= model, dataloader= test_loader, device=device, amp = amp, epoch = 0,session_folder=folder, division="test" )
...
def get_args():
    ...
    parser.add_argument('--ModLoss' , action='store_true', default=False, help='Modified loss function')
